classdef StaticKinetInMass < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function GenerateTIFs(app)
            ...
            if strcmp("All", app.N_Nuf2ColorChannelDropDown.Value) || strcmp("All", app.Spc29ColorChannelDropDown.Value) || strcmp("All", app.KinetochoreColorChannel.Value)
        ...
        function MainLoop(app)
            ...
            filestructure = strcat(app.FileFolderNameStringEditField.Value,'_%0',num2str(floor(log10(app.NumberofXMLstoGenerateSpinner.Value))+1),'d.xml');
    ...
    methods (Access = private)
        ...
        % Callback function: LowerAngleSpinner, UpperAngleSpinner
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.OutputPanel.Position = [814 84 298 406];
